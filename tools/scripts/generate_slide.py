...
_LOGO     = os.path.join(_TMPL_DIR, "ssrinc_logo.png")
_TEMPLATE = os.path.join(_TMPL_DIR, "slide_template.pptx")
...
def new_prs():
    """Presentation 반환 (16:9 와이드).
    templates/slide_template.pptx 존재 시 해당 템플릿 로드,
    없으면 python-pptx 기본 blank 사용.
