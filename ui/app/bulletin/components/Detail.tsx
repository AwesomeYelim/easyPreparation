      ...
      {selectedDetail?.info.includes("edit") && (
        <div key={selectedDetail?.key} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-bold text-navy-dark uppercase tracking-wider flex items-center gap-1">
              Object
            ...
            {(selectedDetail.info.includes("b_") && (
              ...
              <textarea
                ...
                className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm text-navy-dark resize-none min-h-[100px] focus:outline-none focus:border-electric-blue focus:ring-2 focus:ring-electric-blue/20 transition-all"
              />
            )}
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-bold text-navy-dark uppercase tracking-wider flex items-center gap-1">
              Lead
              <span className="text-on-surface-variant text-[10px] font-semibold">right</span>
            </label>
            <input
              type="text"
              ...
              className="w-full px-3 py-2.5 border border-slate-200 rounded-xl text-sm text-navy-dark focus:outline-none focus:border-electric-blue focus:ring-2 focus:ring-electric-blue/20 transition-all"
            />
          </div>
        </div>
      )}
